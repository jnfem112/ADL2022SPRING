...
def my_argparse():
	...
	parser.add_argument('--train_data' , type = str , default = 'data/intent/train.json')
	parser.add_argument('--validation_data' , type = str , default = 'data/intent/eval.json')
	parser.add_argument('--test_data' , type = str , default = 'data/intent/test.json')
	parser.add_argument('--output_file' , type = str , default = 'prediction.csv')
	parser.add_argument('--checkpoint_directory' , type = str , default = './')
	parser.add_argument('--checkpoint' , type = str , default = 'intent_classifier.pth')
